...
int main() {
    ...
    //  1) When Sequence is used, the ConditionNode is executed only __once__ because it returns
    //  SUCCESS. 2) When ReactiveSequence is used, BatteryOK is executed at __each__ tick()
